...
from FillFuncs import fillVWR_Old, fillThomas_Old, fillFisher_Old, fillFisher_Enrichment, fillVWR_Enrichment, fillVWR_New, fillThomas_New, fillFisher_New
...
def VWREnrichmentHelper(filename):
    ...
    root.update()
    magento = pd.read_excel('database_sheets/magento_may.xlsx')
    lbl_main['text'] = 'Filling VWR Enrichment Form'
    root.update()
    fillVWR_Enrichment(filename, magento)
    lbl_main['text'] = 'Done'
